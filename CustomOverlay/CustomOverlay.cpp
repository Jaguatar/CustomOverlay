...
void CustomOverlay::Render(CanvasWrapper canvas)
{
	...
	boostBoxSize.X = (int)((screenSize.X * 10.F) / 100);
	boostBoxSize.Y = (int)((screenSize.X * 10.F) / 100);
	...
	scoreBoxCenterSize.X = (int)((screenSize.X * 7.F) / 100);
	scoreBoxCenterSize.Y = (int)((screenSize.Y * 4.F) / 100);
	...
	scoreBoxLeftSize.X = (int)(((screenSize.X * 2.F) / 100) * 1.25F);
